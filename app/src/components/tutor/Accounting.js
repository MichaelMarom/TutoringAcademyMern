...
import { upload_form_four, upload_form_three } from '../../axios/tutor';
        ...
        <>
            ...
            <div className="tutor-tab-accounting">
                ...
                <div className="tutor-tab-acct-pay-option">
                    ...
                    <div style={{display: 'inline-block', width: '100%', padding: '0'}}>
                        ...
                        <div  style={{float: 'left', margin: '0 0 20px 0', width: '50%'}}>
                            <input style={{float: 'left', width: '30px', cursor: 'pointer', height: '20px', fontSize: 'x-small'}} type="radio" onInput={handle_bank} value='Paypal' name='p-method' id="" />  
                            <span>Paypal</span> 
                        </div>
                        <div  style={{float: 'left', margin: '0 0 20px 0', width: '50%'}}>
                            <input style={{float: 'left', width: '30px', cursor: 'pointer', height: '20px', fontSize: 'x-small'}} type="radio" onInput={handle_bank} value='Zale' name='p-method' id="" />   
                            <span>Zale</span>
                        </div>
                        <div  style={{float: 'left', margin: '0 0 20px 0', width: '50%'}}>
                            <input style={{float: 'left', width: '30px', cursor: 'pointer', height: '20px', fontSize: 'x-small'}} type="radio" value='Bank' onInput={handle_bank} name='p-method' id="" />    
                            <span>Bank</span>
                        </div>
                    </div>
                    ...
                    <div className='tutor-bank-info'>
                        ...
                        <div style={{display: 'inline-block', width: '350px', whiteSpace: 'nowrap'}}>
                            ...
                            <input type="text" onInput={e => set_acct_name(e.target.value)} id="acct-name" style={{float: 'right', width: '60%'}} />
                        </div>
                        ...
                        <div style={{display: 'inline-block', width: '350px', whiteSpace: 'nowrap'}}>
                            ...
                            <input type="text" onInput={e => set_bank_name(e.target.value)} id="bank-name" style={{float: 'right', width: '60%'}} />
                        </div>

                        <div style={{display: 'inline-block', width: '350px', whiteSpace: 'nowrap'}}>
                            <label style={{margin: ' 0 10px 0 0', width: '30%', float: 'left'}} htmlFor="acct">Account #</label>
                            <input type="number" onInput={e => set_acct(e.target.value)} id="acct" style={{float: 'right', width: '60%'}} />
                        </div>

                        <div style={{display: 'inline-block', width: '350px', whiteSpace: 'nowrap'}}>
                            <label style={{margin: ' 0 10px 0 0', width: '30%', float: 'left'}} htmlFor="routing">Routing #</label>
                            <input type="text" onInput={e => set_routing(e.target.value)} id="routing" style={{float: 'right', width: '60%'}} />
                        </div>
                    </div>
                ...
                <div className="tutor-tab-acct-time-range">
                    ...
                    <input onInput={e => set_ssh(e.target.value)} type="text" />
                    ...
                    <div style={{display: 'inline-block', width: '380px', whiteSpace: 'nowrap'}}>
                        ...
                        <input type="text" onInput={e => set_accumulated_hrs(e.target.value)} id="accumulated-hrs" style={{float: 'right',  width: '60%'}} />
                    </div>

                    <div style={{display: 'inline-block', width: '380px', whiteSpace: 'nowrap'}}>
                        <label style={{margin: ' 0 10px 0 0', float: 'left',  width: '20%'}} htmlFor="commission">Commission %</label>
                        <input type="text" onInput={e => set_commission(e.target.value)} id="commission" style={{float: 'right',  width: '60%'}} />
                    </div>

                    <div style={{display: 'inline-block', width: '380px', whiteSpace: 'nowrap'}}>
                        <label style={{margin: ' 0 10px 0 0', float: 'left',  width: '20%'}} htmlFor="total-earning">Total Earning</label>
                        <input type="text" onInput={e => set_total_earning(e.target.value)} id="total-earning" style={{float: 'right',  width: '60%'}} />
                    </div>
